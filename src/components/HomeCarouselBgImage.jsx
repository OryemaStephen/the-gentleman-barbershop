...
const HomeCarouselBgImage = ({ paragraph, heading, button, backgroundImage }) => (
  ...
  >
    <div className="text-white text-center">
        ...
        <button type='button' className='px-3 py-2 border-2 border-white rounded hover:bg-white hover:text-black transition-colors duration-500 ease-in-out' >{button}</button>
    </div>
  </div>
);
