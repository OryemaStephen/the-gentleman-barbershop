  ...
  return (
    <div className="w-full h-full">
      <div className="bg-black w-full grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 p-5">
        <div className='grid-cols-1 pt-3 md:pt-1'>
          ...
          <p className='text-white text-lg'>
            Murdock is a digital agency striving to bring your 
        ...
        <div className='grid-cols-1 pt-3 md:pt-1 sm:border-l-[1px] border-[#C3B299] pl-2'>
          ...
          <ul className='text-white text-lg'>
            <li>
              <Link to='/' className='hover:text-[#C3B299]'>Home</Link>
            </li>
            <li>
              <Link to='/about' className='hover:text-[#C3B299]'>About</Link>
            </li>
            <li>
              <Link to='/services' className='hover:text-[#C3B299]'>Services</Link>
            </li>
            <li>
              <Link to='/gallery' className='hover:text-[#C3B299]'>Gallery</Link>
            </li>
            <li>
              <Link to='/team' className='hover:text-[#C3B299]'>Team</Link>
            </li>
            <li>
              <Link to='/contact' className='hover:text-[#C3B299]'>Contact</Link>
            </li>
          </ul>
        </div>
        <div className='grid-cols-1 pt-3 md:pt-1 lg:border-l-[1px] lg:border-[#C3B299] lg:pl-2'>
          ...
          <div className='text-white text-lg'>
            <span className='text-[#C3B299] flex items-center'>
              <IoMail /> <span className='text-white pl-2'>gentlemanbarbershop@gmail.com</span>
            </span>
            <span className='text-[#C3B299] flex items-center'>
              <MdOutlinePhoneAndroid /> <span className='text-white pl-2'>+256 777 777000</span>
            </span>
            <span className='text-[#C3B299] flex items-center'>
              <FaLocationDot /> <span className='text-white pl-2'>
        ...
        <div className='grid-cols-1 pt-3 md:pt-1 sm:border-l-[1px] border-[#C3B299] pl-2'>
          ...
          <form className='text-lg text-white'>
            <input type="text" placeholder='Email' className='border-none border-b-2 border-[grey] mb-2 p-1'/><br />
            <button type="submit" className='bg-[#C3B299] text-black p-2 rounded'>Send</button>
          </form>
        </div>
      </div>
      <div className="text-center py-8">
        ...
        <a href="https://oryemasteph.netlify.app" target="_blank" rel="noopener noreferrer"> Stephen Oryema</a>
      </div>
    </div>
  );
}
